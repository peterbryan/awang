...
Then, just browse to [mlocal.alexanderwang.com](http://mlocal.alexanderwang.com) and you are ready to start developing!
...
Remember to put all domains you're going to hit in your etc/hosts or to run your server with the `-auto-hosts=true` option.
    ...
    127.0.0.1   mlocal.alexanderwang.com
    127.0.0.1   mlocal.store.alexanderwang.com
